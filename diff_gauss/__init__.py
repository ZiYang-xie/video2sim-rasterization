...
def rasterize_gaussians(
    ...
    color, depth, norm, alpha, radii, extra, gs_w = _RasterizeGaussians.apply(
        means3D,
        means2D,
        sh,
        colors_precomp,
    ...
    # 3, H, W
    return color, depth, norm, alpha, radii, extra, gs_w
...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, norm, alpha, radii, extra, geomBuffer, binningBuffer, imgBuffer, gs_w = _C.rasterize_gaussians(*args)
    ...
    @staticmethod
    def backward(ctx, grad_out_color, grad_out_depth, grad_out_norm, grad_out_alpha, _, grad_out_extra, grad_gs_w):
